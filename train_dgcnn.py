########################################################################################################################
# print(regex_dict.__contains__("sad"))
# for e in x.edges(x.nodes,data=True):
#     print(e[2]['weight'])
########################################################################################################################
from dgcnn_data_util import load_data, cmd_args, get_regex_dict, get_tag_dict, get_embeddings_dict
import sys
import os
import torch
import random
...
class Classifier(nn.Module):
    ...
    def save(self):
        ...
        torch.save(self.state_dict(), 'model/model_state.pt')
